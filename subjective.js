...
(function(){
  ...
  function _injectSubjFont(){ if(document.getElementById('subjFontUnify')) return;
    ...
    +'.subj-view .subj-tbl th,.subj-view .subj-tbl td{border:1px solid #9FB3C8;padding:6px 11px;line-height:1.5;word-break:keep-all}'
    +'.subj-view .subj-tbl th{background:#EEF2F6;text-align:center;font-weight:600;color:#334E68;white-space:nowrap}'
    +'.subj-view .subj-tbl caption ~ tbody td{text-align:right;font-variant-numeric:tabular-nums}'
    +'.subj-view .subj-tbl tr td:first-child{text-align:center;font-weight:600;background:#F7F9FB;color:#334E68}'
